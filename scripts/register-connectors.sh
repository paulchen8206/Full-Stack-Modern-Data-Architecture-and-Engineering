...
case "$CONNECT_SCOPE" in
  debezium)
    CONFIG_DIRS=("$SCRIPT_DIR/../debizum-connect/connector-configs")
    ;;
  mdm)
    CONFIG_DIRS=("$SCRIPT_DIR/../mdm-connect/connector-configs")
    ;;
  all)
    CONFIG_DIRS=(
      "$SCRIPT_DIR/../debizum-connect/connector-configs"
      "$SCRIPT_DIR/../mdm-connect/connector-configs"
    )
    ;;
  *)
