...
# Usage:
#   ./platform-services/kafka/kafka-topics.sh create [--topics topic1,topic2,...]
#   ./platform-services/kafka/kafka-topics.sh list
#   ./platform-services/kafka/kafka-topics.sh consume <topic> [message-count]
#   ./platform-services/kafka/kafka-topics.sh check-pipeline [--topics topic1,topic2,...] [--count N]
