...
public class RealtimeProperties {
    ...
    private String consumerStartOffset = "latest";
    ...
    public String getConsumerStartOffset() {
        return consumerStartOffset;
    }

    public void setConsumerStartOffset(String consumerStartOffset) {
        this.consumerStartOffset = consumerStartOffset;
    }
